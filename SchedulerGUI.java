...
public class SchedulerGUI extends JFrame implements ActionListener {
  ...
  public SchedulerGUI() {
    ...
    con.add(pane);
    //displayData.setMnemonic('P'); // associate hotkey
    displayData.addActionListener(this);   // register button listener
    ...
    pq = new MinHeap();
		...
		try{
			Load();
			pL(0);
      dataDisplay.setText(GetAssignments());
		}
		catch(Exception e){
